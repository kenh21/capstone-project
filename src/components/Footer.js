...
function Footer() {
    return (
        <Container fluid className='footer p-5' aria-label='footer'>
            ...
            <Col className='mt-2'>
           <Nav className='d-flex flex-column justify-content-space-around ms-3' aria-label='website navigation'>
        ...
        <Col className='mt-2'>
            <Nav className='d-flex flex-column justify-content-space-around ms-lg-3 ms-md-3 ms-sm-3 ms-xs-3'aria-label='contact info'>
        ...
        <Col className='mt-2'>
            <Nav className='d-flex flex-column justify-content-space-around ms-3' aria-label='contact info'>
                <Nav.Link className='text-dark fw-bolder ' href='#'>Address</Nav.Link>
                <Nav.Link className='text-dark fw-bolder ' href='#'>Phone Number</Nav.Link>
                <Nav.Link className='text-dark fw-bolder ' href='#'>Email</Nav.Link>
            </Nav>
